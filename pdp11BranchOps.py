...
class branchOps:
    ...
    def BLOS(self, instruction, offset):
        ...
        if self.psw.C() | self.psw.Z() == 1:
            ...
            self.reg.inc_pc('No Branch BLOS')
        return True
    ...
    def do_branch(self, instruction):
        ...
        print(f'branch operation {oct(instruction)}')
